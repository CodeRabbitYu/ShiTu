      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container}>
        ...
        >
          <TouchableOpacity onPress={() => this.setState({ type: 1 })}>
            <Text style={styles.text}>SectionList1</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => this.setState({ type: 2 })}>
            <Text style={styles.text}>LargeList2</Text>
          </TouchableOpacity>
        </View>
        <TouchableOpacity
        ...
        >
          <Text style={styles.text}>LargeListSample4</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{ alignItems: "center" }}
          onPress={() => this.setState({ type: 5 })}
        >
          <Text style={styles.text}>LargeListSample5</Text>
        </TouchableOpacity>
      </ScrollView>
    );
  }
